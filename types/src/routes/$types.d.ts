...
type LayoutRouteId = RouteId | "/" | "/(demos)/bohr-atoms" | "/(demos)/color-bar" | "/(demos)/color-scales" | "/(demos)/element-color-schemes" | "/(demos)/element-tile" | "/(demos)/molecule" | "/(demos)/nucleus" | "/(demos)/periodic-table" | "/(demos)/structure" | "/404" | "/[slug]" | "/acknowledgements" | "/api" | "/changelog" | "/contributing" | "/mp-[slug]" | null
