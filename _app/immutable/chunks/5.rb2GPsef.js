...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>PeriodicTable</span><span class="token punctuation">></span></span>`,t;return{c(){a=new ia(!1),t=D(),this.h()},l(n){a=ka(n,!1),t=D(),this.h()},h(){a.a=t},m(n,s){a.m(e,n,s),m(n,t,s)},p:A,d(n){n&&(k(t),a.d())}}}function Mn(p){let a;const e=p[0].default,t=O(e,p,p[1],Ba),n=t||Pn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?R(e,s[1],l,on):q(s[1]),Ba)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}var Ea,xa,Ha,La;function In(p){let a,e="<code>ColorBar.svelte</code>",t,n,s="Here’s a <code>ColorBar</code> with tick labels:",l,c,o,g,i,h="<code>ColorBar</code> supports <code>label_side = [&#39;top&#39;, &#39;bottom&#39;, &#39;left&#39;, &#39;right&#39;]</code>",r,$,I,F,z,_="You can make fat and skinny bars:",v,H,V,E,N,da="<code>PeriodicTable.svelte</code> heatmap example with <code>ColorBar</code> inside <code>TableInset</code>",pa,J,L,la;return o=new oa({props:{src:String.raw(Ea||(Ea=X([`<script>
...
/>
{/each}
</div>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/janosh/elementari",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[hn],example:[gn]},$$scope:{ctx:p}}}),I=new oa({props:{src:String.raw(xa||(xa=X([`<script>
import { ColorBar } from '$lib'
...
{/each}
</section>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/janosh/elementari",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[yn],example:[$n]},$$scope:{ctx:p}}}),V=new oa({props:{src:String.raw(Ha||(Ha=X([`<script>
import { ColorBar } from '$lib'
...
</PeriodicTable>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/janosh/elementari",hideStyle:!0,example:!0,stackblitz:!0,code_above:!0},$$slots:{code:[Mn],example:[Tn]},$$scope:{ctx:p}}}),{c(){a=y("p"),a.innerHTML=e,t=T(),n=y("p"),n.innerHTML=s,l=T(),c=y("div"),C(o.$$.fragment),g=T(),i=y("p"),i.innerHTML=h,r=T(),$=y("div"),C(I.$$.fragment),F=T(),z=y("p"),z.textContent=_,v=T(),H=y("div"),C(V.$$.fragment),E=T(),N=y("p"),N.innerHTML=da,pa=T(),J=y("div"),C(L.$$.fragment)},l(u){a=w(u,"P",{"data-svelte-h":!0}),Z(a)!=="svelte-1lubuts"&&(a.innerHTML=e),t=P(u),n=w(u,"P",{"data-svelte-h":!0}),Z(n)!=="svelte-1kqeevu"&&(n.innerHTML=s),l=P(u),c=w(u,"DIV",{});var b=M(c);j(o.$$.fragment,b),b.forEach(k),g=P(u),i=w(u,"P",{"data-svelte-h":!0}),Z(i)!=="svelte-1dl7v3e"&&(i.innerHTML=h),r=P(u),$=w(u,"DIV",{});var U=M($);j(I.$$.fragment,U),U.forEach(k),F=P(u),z=w(u,"P",{"data-svelte-h":!0}),Z(z)!=="svelte-qjibpt"&&(z.textContent=_),v=P(u),H=w(u,"DIV",{});var Y=M(H);j(V.$$.fragment,Y),Y.forEach(k),E=P(u),N=w(u,"P",{"data-svelte-h":!0}),Z(N)!=="svelte-tgr1oa"&&(N.innerHTML=da),pa=P(u),J=w(u,"DIV",{});var G=M(J);j(L.$$.fragment,G),G.forEach(k)},m(u,b){m(u,a,b),m(u,t,b),m(u,n,b),m(u,l,b),m(u,c,b),S(o,c,null),m(u,g,b),m(u,i,b),m(u,r,b),m(u,$,b),S(I,$,null),m(u,F,b),m(u,z,b),m(u,v,b),m(u,H,b),S(V,H,null),m(u,E,b),m(u,N,b),m(u,pa,b),m(u,J,b),S(L,J,null),la=!0},p(u,[b]){const U={};b&2&&(U.$$scope={dirty:b,ctx:u}),o.$set(U);const Y={};b&2&&(Y.$$scope={dirty:b,ctx:u}),I.$set(Y);const G={};b&2&&(G.$$scope={dirty:b,ctx:u}),V.$set(G);const ha={};b&2&&(ha.$$scope={dirty:b,ctx:u}),L.$set(ha)},i(u){la||(f(o.$$.fragment,u),f(I.$$.fragment,u),f(V.$$.fragment,u),f(L.$$.fragment,u),la=!0)},o(u){d(o.$$.fragment,u),d(I.$$.fragment,u),d(V.$$.fragment,u),d(L.$$.fragment,u),la=!1},d(u){u&&(k(a),k(t),k(n),k(l),k(c),k(g),k(i),k(r),k($),k(F),k(z),k(v),k(H),k(E),k(N),k(pa),k(J)),B(o),B(I),B(V),B(L)}}}function Vn(p,a,e){let{$$slots:t={},$$scope:n}=a;return p.$$set=s=>{"$$scope"in s&&e(1,n=s.$$scope)},[t,n]}class zn extends ta{constructor(a){super(),ea(this,a,Vn,In,sa,{})}}const An=Object.freeze(Object.defineProperty({__proto__:null,default:zn},Symbol.toStringTag,{value:"Module"}));export{zn as P,An as _};
